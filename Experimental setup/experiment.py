from experiment_classes import TFIMExperiment, KitaevExperiment, MBLExperiment
from plotting import plot_matrix, plot_order, plot_pca

# prepare dataset
exp = TFIMExperiment(40) # KitaevExperiment(), MBLExperiment(8)

# model-specific hyperparameters
lr = 0.01 if not exp.dataset_name in ["ising", "potts"] else 0.1 # TODO
